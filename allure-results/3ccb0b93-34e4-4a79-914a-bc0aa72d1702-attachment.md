...
```
Error: locator.scrollIntoViewIfNeeded: Error: strict mode violation: locator('.product-image-wrapper') resolved to 40 elements:
    1) <div class="product-image-wrapper">…</div> aka getByText('Rs. 500 Blue Top Add to cart Rs. 500 Blue Top Add to cart View Product')
    2) <div class="product-image-wrapper">…</div> aka getByText('Rs. 400 Men Tshirt Add to cart Rs. 400 Men Tshirt Add to cart View Product')
    3) <div class="product-image-wrapper">…</div> aka locator('div:nth-child(5) > .product-image-wrapper')
    4) <div class="product-image-wrapper">…</div> aka getByText('Rs. 1500 Stylish Dress Add to cart Rs. 1500 Stylish Dress Add to cart View')
    5) <div class="product-image-wrapper">…</div> aka getByText('Rs. 600 Winter Top Add to cart Rs. 600 Winter Top Add to cart View Product')
    6) <div class="product-image-wrapper">…</div> aka getByText('Rs. 400 Summer White Top Add to cart Rs. 400 Summer White Top Add to cart View')
    7) <div class="product-image-wrapper">…</div> aka locator('div:nth-child(9) > .product-image-wrapper')
    8) <div class="product-image-wrapper">…</div> aka getByText('Rs. 700 Fancy Green Top Add to cart Rs. 700 Fancy Green Top Add to cart View')
    9) <div class="product-image-wrapper">…</div> aka locator('div:nth-child(11) > .product-image-wrapper')
    10) <div class="product-image-wrapper">…</div> aka locator('div:nth-child(12) > .product-image-wrapper')
    ...

Call log:
  - waiting for locator('.product-image-wrapper')

    at HomePage.addProducts (C:\Users\Administrator\Desktop\AyshaMohsin_AssessmentTasks\src\pages\homePage.ts:46:20)
...
```ts
  ...
  44 |
  45 |
> 46 | await this.product.scrollIntoViewIfNeeded();
     |                    ^ Error: locator.scrollIntoViewIfNeeded: Error: strict mode violation: locator('.product-image-wrapper') resolved to 40 elements:
  47 |
  48 |             const name = await this.product.nth(i).locator('text=Stylish Dress').textContent();
  49 |
  50 |             console.log(" my name is " , name)
  51 |             
  52 |
  53 |             if(name?.trim()===targetProductName){
  54 |                 await this.product.locator('text=Add to cart').click();
  55 |                 console.log(`Click add to cart for : ${targetProductName}`);
  56 |                 break;
  57 |
  58 |             }
  59 |
