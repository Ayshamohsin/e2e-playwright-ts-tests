...
Locator: getByText('Congratulations! Your new account has been successfully created!')
Expected string: "Congratulations! Your new account has been successfully created!"
Received: <element(s) not found>
Call log:
  - expect.toHaveText with timeout 5000ms
  - waiting for getByText('Congratulations! Your new account has been successfully created!')
...
- banner:
  ...
  - list:
    ...
    - listitem:
      - link " Contact us":
        - /url: /contact_us
    - listitem:  Logged in as Dr. Mack Homenick
- list:
  - listitem
  - listitem
  - listitem
