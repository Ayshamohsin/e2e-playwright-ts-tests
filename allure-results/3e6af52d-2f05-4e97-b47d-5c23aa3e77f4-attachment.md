...
Call log:
  - waiting for locator('form-control')
    ...
    at CheckOut.addDescriptionAndPlaceOrder (C:\Users\Administrator\Desktop\AyshaMohsin_AssessmentTasks\src\pages\checkOut.ts:107:32)
...
- banner:
  ...
  - list:
    ...
    - listitem:
      - link " Contact us":
        - /url: /contact_us
    - listitem:  Logged in as Michelle Johns
- list:
  - listitem:
    - link "Home":
      - /url: /
...
- list:
  ...
  - listitem: Mrs. Adriel Olson
  - listitem: Herzog, Kohler and Kemmer
  - listitem: 9558 Koch Well
  - listitem: Apt. 306
  - listitem: Reyfield Idaho 41723-4959
  - listitem: New Zealand
  - listitem: 1-785-351-0425 x000
- list:
  - listitem:
...
> 107 |     await this.commentTextArea.fill('I ahave revied my delivery address and order detail.');
      |                                ^ Error: locator.fill: Test timeout of 30000ms exceeded.
  108 |     await this.placeOrderButton.click();
  109 | }
  110 |
  111 |
  112 |
